        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text('যুদ্ধ বিরতির প্রথম দিনে গাজায় গেল ২০০ ত্রাণবাহী ট্রাক',maxLines: 3,overflow: TextOverflow.fade,style: AppStyle.roseMadderTextStyle().copyWith(fontSize: 30,fontWeight: FontWeight.bold),),
            ],
          ),
        ),
      ),
